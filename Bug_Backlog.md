...
| R-012 | RISK | 2026-08-08 | hub / battery | **Unexplained idle drain.** The ring fell 80% → 1% in 6.8 days *with automatic HR logging disabled*, so PPG was not responsible. Remaining suspects: continuous BLE advertising, the accelerometer, or other auto-sensing whose opcodes are still unknown. This matters because the battery contract assumes PPG duty cycle dominates — if idle draw is the real floor, reducing HR frequency buys less than expected. Measure the new drain rate at HR=30min against the 12%/day factory baseline. |
